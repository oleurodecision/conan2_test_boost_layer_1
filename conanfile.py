...
class Layer1Conan(ConanFile):
    # package reference
    name, version = "layer1", "0.0"

    # metadata
    description = "conan2_test_boost_layer1"
    license = "MIT"
    author = "Olivier Liess"
    homepage = "https://github.com/oleurodecision/conan2_test_boost_layer1"
